    ...
    <>
      ...
      <section className="about-content py-5">
        <div className="container position-relative">
          ...
          <div className="position-absolute bottom-0 w-100 end-0 d-none d-md-block" style={{ zIndex: -1 }}>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="abt-img2 col-md-6 mb-4 mb-md-0">
              <img src={ourApproachImg} className="img-fluid" alt="Our Approach" />
            </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="abt-img3 col-md-6">
              <img src={whyUsImg} className="img-fluid" alt="Why Choose Us" />
            </div>
          </div>
        </div>
      </section>
