...
import {
  getProfile,
  profileUpdate,
} from "../../../Api/functions/profileFunction";
...
const EditProfile = () => {
  ...
  // When profileData is updated, set formData and preview image
  useEffect(() => {
    if (profileData) {
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    profileUpdate(data, navigate, setLoading);
  };
  ...
  return (
    <section className="position-relative min-vh-100 d-flex align-items-center justify-content-center">
      <img
        ...
        style={{ width: "150px", opacity: 0.5, top: "70%", zIndex: -1 }}
      />
      ...
      <img
        ...
        style={{ width: "150px", opacity: 0.5, zIndex: -1 }}
      />
      ...
      <Container>
        <Row className="d-flex align-items-start justify-content-center py-3">
          <Col xs={12} md={4} lg={4} className="text-center mb-4 mb-md-0">
            <div className="position-relative d-inline-block">
              ...
              <label
                ...
                className="btn btn-light p-1 rounded-circle position-absolute"
                style={{
                  bottom: "0",
                  right: "0",
          ...
          <Col xs={12} md={8} lg={8}>
            <div
              className="bg-white p-2 p-md-4 rounded-4 shadow-lg"
              style={{
                background: "linear-gradient(to right, #f9f9f9, #e0f1ff)",
              }}
            >
              <h4 className="mb-2 text-center fw-bold text-primary">
                Edit Profile
              </h4>
