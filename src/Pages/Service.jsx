      ...
      <div>
        ...
        <section className="py-5">
            ...
            <div className="row align-items-center">
                ...
                <img src={img1} className="img-fluid" alt="Smart Expense Tracking" />
                </div>
        ...
        <section className="py-5 bg-light">
            ...
            <div className="row align-items-center flex-lg-row-reverse">
                <div className="col-lg-6 mb-4 mb-lg-0">
                <img src={img2} className="img-fluid" alt="Budget Planning" />
                </div>
                <div className="col-lg-6">
        ...
        <section className="py-5">
            ...
            <div className="row align-items-center">
                <div className="col-lg-6 mb-4 mb-lg-0">
                <img src={img3} className="img-fluid" alt="Savings Goals" />
                </div>
                <div className="col-lg-6">
        ...
        <section className="py-5 bg-light">
            ...
            <div className="row align-items-center flex-lg-row-reverse">
                <div className="col-lg-6 mb-4 mb-lg-0">
                <img src={img4} className="img-fluid" alt="Reports and Insights" />
                </div>
                <div className="col-lg-6">
