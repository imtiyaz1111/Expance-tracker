...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    login(data, navigate, setLoading, auth, setAuth, profileCreate, setProfileCreate);
  };
          ...
          <div className="row w-100 d-flex justify-content-center align-items-center gap-5">
            ...
            <div className="col-lg-6 login-form-area">
              ...
              <form className="login-form" onSubmit={handleSubmit}>
                ...
                <input type="submit" className="form-control rounded-4 py-2 px-3 fw-semibold" value={loading ? "Logging in..." : "LOG IN"} disabled={loading} />
                ...
                <div className="d-flex justify-content-between align-items-center mt-4 new-user">
                  ...
                  <div className="terms-links text-end">
                    <Link to="/terms" className="text-primary fw-medium me-2">Terms & Conditions</Link> |
