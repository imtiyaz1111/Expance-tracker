...
console.log("allReviewData",allReviewData);
  ...
  return (
    <>
              ...
              <div className="accordion" id="accordionExample">
                <div className="accordion-item mb-3">
                  <h2 className="accordion-header" id="headingOne">
                    ...
                    >
                      <img src={icon1} alt="icon" className="me-2" width="20" />
                ...
                <div className="accordion-item mb-3">
                  <h2 className="accordion-header" id="headingTwo">
                    ...
                    >
                      <img src={icon2} alt="icon" className="me-2" width="20" />
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingThree">
                    ...
                    >
                      <img src={icon3} alt="icon" className="me-2" width="20" />
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6 col-lg-6">
              <div className="p-4 bg-white rounded shadow-custom h-100">
                ...
                <img src={budget} alt="Budgets" className="img-fluid rounded" />
              </div>
            </div>
          ...
          <div className="row justify-content-center g-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="pricing-card p-4 h-100">
                ...
                <button className="btn btn-outline-primary mt-4 w-100 rounded-pill">
                  Get Started
                </button>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="pricing-card p-4 h-100 position-relative border-primary border-2 shadow">
                ...
                <button className="btn btn-primary mt-4 w-100 rounded-pill">
                  Get Started
                </button>
              </div>
            </div>
      ...
      {/* review section */}
      <div className="section py-5 px-3 bg-light-blue">
        <div className="container">
          <div className="row align-items-center">
            {/* Review Cards Swiper */}
              ...
              >
                {allReviewData.map((review, index) => (
                  <SwiperSlide key={index}>
                    <div className="review-card bg-white rounded-4 p-4 shadow">
                      <p className="text-secondary small mb-2">{review.comment}</p>
                      <p className={`mb-1 ${review.color}`}>{review.name}</p>
                      <div>
                        {[...Array(5)].map((_, i) => (
                          <span
                            key={i}
            ...
            {/* Right Content */}
            <div className="col-md-5 text-center text-md-start mt-4 mt-md-0">
              <h5 className="fw-bold">What Our Users are saying</h5>
