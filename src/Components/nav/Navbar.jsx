...
function Navbar() {
  ...
  return (
    <nav className={`navbar fixed-top ${navCss.nav_wrapper}`}>
      <div className="container-fluid d-flex justify-content-between align-items-center px-xl-5">
        ...
        <div className={navCss.logo}>
          ...
          >
            <span className="text-uppercase">Expansio</span>
        ...
        {/* Buttons */}
        <div className={`${navCss.Nav_btns} d-flex align-items-center`}>
          <Link to={authCookie ? "/dashboard" : "/login"}>
            <button className="nav-btn d-xl-inline-flex">
