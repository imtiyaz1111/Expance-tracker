...
export const createExpense = async (data) => {
  try {
    const res = await axiosInstance.post(Expense_ENDPOINTS.CREATE_Expense, data);
    if (res) {
...
export const updateExpense = async (id, data) => {
  try {
    const res = await axiosInstance.put(Expense_ENDPOINTS.UPDATE_Expense(id), data);
    if (res) {
...
export const deleteExpense = async (id) => {
  try {
    const res = await axiosInstance.delete(Expense_ENDPOINTS.DELETE_Expense(id));
    if (res) {
